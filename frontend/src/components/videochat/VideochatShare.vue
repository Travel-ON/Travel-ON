  ...
  <v-container v-if="publisher" id="main-container" class="container" style="max-width: 1200px">
    <v-row id="join">
      <v-col id="join-dialog" class="jumbotron vertical-center">
        <h1 style="border-bottom: 4px solid #adadad">방 코드 입장</h1>
          ...
          <v-col style="background-color: skyblue; border-radius: 8px 0 0 8px; border-right: 4px solid #fff" cols="4">
            <div>
              ...
              <div class="setting" style="background-color: white; border-radius: 8px">
                <v-container fluid>
                  <div style="margin-bottom: 32px; font-size: 24px">
                    <div style="border-bottom: 2px solid #adadad">방 코드 입력</div>
                    <v-text-field
                      label="방 코드"
                      v-model="roomCode"
                      hide-details
        ...
        <v-btn
          ...
          size="x-large"
          ><v-icon>mdi-check-outline </v-icon>&nbsp;방 입장하기</v-btn
        >
      </v-col>
    </v-row>
  </v-container>
