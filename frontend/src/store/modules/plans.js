...
export const Plans = {
  ...
  mutations: {
    ...
    SET_CONVERTED_HISTORY_LIST_MODAL: (state, convertedHistoryListModal) =>
      (state.convertedHistoryListModal = convertedHistoryListModal),
    SET_EXPECT_HISTORY_LIST: (state, expectHistoryList) => (state.expectHistoryList = expectHistoryList),
    SET_EXPECT_HISTORY_LIST_MODAL: (state, expectHistoryListModal) =>
      (state.expectHistoryListModal = expectHistoryListModal),
    SET_CONVERTED_EXPECT_HISTORY_LIST: (state, convertedExpectHistoryList) =>
      (state.convertedExpectHistoryList = convertedExpectHistoryList),
  },
  actions: {
